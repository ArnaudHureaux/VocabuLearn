...
class LanguageClone extends StatefulWidget {
  // const LanguageClone({Key? key}) : super(key: key);
  final folderPath;
  LanguageClone(this.folderPath);

  @override
  _LanguageCloneState createState() => _LanguageCloneState(this.folderPath);
}

class _LanguageCloneState extends State<LanguageClone> {
  final folderPath;
  _LanguageCloneState(this.folderPath);
  //settings
...
//prix et nb de mots
  ...
  late List current_values = [speak, learn];
//fonctions finales
          ...
          DropdownButton<String>(
              ...
              items: speaks_learns[i].map((String value) {
                return DropdownMenuItem<String>(
                  value: value,
                  child: Row(children: [Text(value)]), //appLogo2
                );
              }).toList(),
              onChanged:
