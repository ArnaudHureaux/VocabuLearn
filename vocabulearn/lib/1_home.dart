                ...
                SizedBox(
                    ...
                    child: Card(
                        child: Center(
                            child: (timeout)
                                ? Text(
                                    'Fail to connect to the online words database... \n  Please restart the app with Internet')
                                : Text(
                                    'Connection to the \n30 000 words database...')))),
                CircularProgressIndicator(),
              ]),
            if (display_popup)
              AlertDialog(
                title: Text("Not enough words to learn"),
                content: Text(
                    "Please select at least 6 words to learn before starting the training modules."),
                actions: [
                  TextButton(
