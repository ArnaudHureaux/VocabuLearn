...
class _AccountState extends State<Account> {
  ...
  //listes de mots
  late List en_learning = import_list(file_en_learning);
  late List fr_learning = import_list(file_fr_learning);
  late List en_learned = import_list(file_en_learned);
  late List fr_learned = import_list(file_fr_learned);
  late List ids_notlearn = import_list(file_ids_notlearn);
  //other late
